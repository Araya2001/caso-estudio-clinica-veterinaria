...
import tech.aarayaj.casoestudioclinicaveterinaria.ui.form.BaseEntityForm;
import tech.aarayaj.casoestudioclinicaveterinaria.ui.hlbutton.GridActionButtonLayout;
import tech.aarayaj.casoestudioclinicaveterinaria.ui.hlbutton.GridColumnActionButtonLayout;
import tech.aarayaj.casoestudioclinicaveterinaria.ui.style.StyleComponent;

public abstract class BaseEntityGrid<T extends BaseEntityLayerOne> extends Div implements StyleComponent {

    // Grid must be protected for subclasses to access the attribute
    protected final Grid<T> baseEntityGrid;
    protected final BaseEntityForm<T> baseEntityForm;
    protected final Div baseEntityFormDiv;
    protected final BaseEntityService<T> baseEntityService;
    ...
    public BaseEntityGrid(Grid<T> baseEntityGrid, BaseEntityForm<T> baseEntityForm, BaseEntityService<T> baseEntityService, String title) {
    ...
    protected ComponentRenderer<Div, T> mapActionToButtonLayoutFromColumnAction() {
