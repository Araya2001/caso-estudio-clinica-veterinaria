package tech.aarayaj.casoestudioclinicaveterinaria.ui.hlbutton;
...
public class FormButtonLayout<T extends BaseEntityLayerOne> extends HorizontalLayout {
    ...
    private final BaseEntityService<T> entityService;
    private final Binder<T> binder;


    public FormButtonLayout(BaseEntityService<T> entityService, Binder<T> binder) {
